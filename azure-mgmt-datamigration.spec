...
Source0  : https://files.pythonhosted.org/packages/96/7e/e8735fb1ffa239ee3e10b98c76467e072e055fcb56b052c50f8384bcb8ae/azure-mgmt-datamigration-4.1.0.zip
Summary  : Microsoft Azure Data Migration Client Library for Python
Group    : Development/Tools
License  : MIT
Requires: azure-mgmt-datamigration-python = %{version}-%{release}
Requires: azure-mgmt-datamigration-python3 = %{version}-%{release}
...
%package python
Summary: python components for the azure-mgmt-datamigration package.
Group: Default
Requires: azure-mgmt-datamigration-python3 = %{version}-%{release}

%description python
python components for the azure-mgmt-datamigration package.


%package python3
Summary: python3 components for the azure-mgmt-datamigration package.
Group: Default
Requires: python3-core
Provides: pypi(azure_mgmt_datamigration)
Requires: pypi(azure_common)
Requires: pypi(msrest)
Requires: pypi(msrestazure)

%description python3
python3 components for the azure-mgmt-datamigration package.


%prep
%setup -q -n azure-mgmt-datamigration-4.1.0
cd %{_builddir}/azure-mgmt-datamigration-4.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1608046219
